...
export const About = () => {
    return (
        <div className='md:py-20 sm:py-8 py-4' id="skills">
            ...
            <h3 className="text-3xl sm:mt-3 mt-20 md:text-5xl lg:mb-16 mb-8 uppercase text-transparent dark:stroke-orange-500 stroke-stone-900" data-aos="fade-up" data-aos-duration="1000">SKILLS</h3>
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-sm text-orange-500 dark:text-orange-400">100%</span>
                        </div>
                        <div className="w-full h-2 bg-orange-500/40 dark:bg-gray-700 rounded-full overflow-hidden">
                            <div className="w-full h-full bg-orange-500 dark:bg-orange-400 rounded-full transition-all duration-1000"></div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between items-center">
                    ...
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-sm text-orange-500 dark:text-orange-400">80%</span>
                        </div>
                        <div className="w-full h-2 bg-orange-500/40 dark:bg-gray-700 rounded-full overflow-hidden">
                            <div className="w-[80%] h-full bg-orange-500 dark:bg-orange-400 rounded-full transition-all duration-1000"></div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between items-center">
                            <p className="font-semibold">J Query</p>
                            <span className="text-sm text-orange-500 dark:text-orange-400">70%</span>
                        </div>
                        <div className="w-full h-2 bg-orange-500/40 dark:bg-gray-700 rounded-full overflow-hidden">
                            <div className="w-[70%] h-full bg-orange-500 dark:bg-orange-400 rounded-full transition-all duration-1000"></div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between items-center">
                            <p className="font-semibold">TypeScript</p>
                            <span className="text-sm text-orange-500 dark:text-orange-400">95%</span>
                        </div>
                        <div className="w-full h-2 bg-orange-500/40 dark:bg-gray-700 rounded-full overflow-hidden">
                            <div className="w-[95%] h-full bg-orange-500 dark:bg-orange-400 rounded-full transition-all duration-1000"></div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between items-center">
                            <p className="font-semibold">React.js</p>
                            <span className="text-sm text-orange-500 dark:text-orange-400">90%</span>
                        </div>
                        <div className="w-full h-2 bg-orange-500/40 dark:bg-gray-700 rounded-full overflow-hidden">
                            <div className="w-[90%] h-full bg-orange-500 dark:bg-orange-400 rounded-full transition-all duration-1000"></div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between items-center">
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-sm text-orange-500 dark:text-orange-400">85%</span>
                        </div>
                        <div className="w-full h-2 bg-orange-500/40 dark:bg-gray-700 rounded-full overflow-hidden">
                            <div className="w-[85%] h-full bg-orange-500 dark:bg-orange-400 rounded-full transition-all duration-1000"></div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-3">
                        <div className="flex justify-between items-center">
