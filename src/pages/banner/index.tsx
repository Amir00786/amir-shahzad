            ...
            <div className="flex flex-col-reverse md:flex-row items-center justify-between -mx-4">
                ...
                <div className="w-full lg:w-1/2 flex items-end justify-end px-4 pt-20 lg:pt-0" data-aos="flip-up" data-aos-duration="2000">
                    <div className="relative w-full md:w-[450px] h-60 sm:h-80 lg:w-[590px] lg:h-96 rounded-4xl bg-orange-400/10 dark:bg-orange-500/20 overflow-visible transition-colors duration-300">
                        <div className="absolute -top-1/2 left-1/2 -translate-x-1/2 rounded-full w-[250px] h-[250px] sm:w-[300px] sm:h-[300px] xl:w-[450px] xl:h-[450px] bg-orange-500 dark:bg-orange-600 overflow-hidden shadow-lg dark:shadow-orange-500/20 transition-all duration-300">
                            <img
                                src={profile}
                                alt="profile"
