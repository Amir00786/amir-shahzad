...
export const Header = () => {
    ...
    return (
        <header
            className="py-6 border-b border-white/20 fixed top-0 left-0 right-0 z-50 bg-stone-900"
            data-aos="fade-down"
        ...
        >
            <div className="flex justify-between items-center mx-auto px-4 max-w-[1440px]">
                <strong>
                    <a
                        href="/"
                        className="text-2xl lg:text-4xl flex items-center gap-2 font-bold text-white"
                    >
            ...
            >
                ...
                <div
                    ref={menuRef}
                    className={`absolute top-0 h-screen right-0 w-64 bg-stone-800 text-white transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"
                        }`}
                >
                    <div
